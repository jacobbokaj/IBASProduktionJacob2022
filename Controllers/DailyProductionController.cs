...
namespace IbasAPI.Controllers
{
    ...
    public class DailyProductionController : ControllerBase
    {
        ...
        public DailyProductionController(ILogger<DailyProductionController> logger)
        {
            ...
            this.tableClient = new TableClient(new Uri("https://jacob360.table.core.windows.net"), "IBASProduction2022Jacob", new TableSharedKeyCredential("jacob360", "ksz2+P/Ljz5IaWK/tSZX8TROrciUFnipECk1SWJ1hr1scY+z6acHYoRZu7zTgBd6on72huQkkp5I+ASt1h4mOw=="));
